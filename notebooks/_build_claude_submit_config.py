"""Build notebooks/claude_submit_config.ipynb — the 0.880 submission PLUS the ILP asymmetry.
...
OUT = Path("/workspace/biohub-cell_tracking_during_development/notebooks/claude_submit_config.ipynb")
CELLS = []
