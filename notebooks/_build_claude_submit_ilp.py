"""Build notebooks/claude_submit_ilp.ipynb — the 0.880 submission PLUS the ILP asymmetry.
...
OUT = Path("/workspace/biohub-cell_tracking_during_development/notebooks/claude_submit_ilp.ipynb")
CELLS = []
...
# THE ONE CHANGE from the 0.880 submission: disappearance 0.1 -> 0.5.
# notes/31: asym0.1_0.5 + repair measured +0.0152 vs the +0.0115 that scored 0.880,
# and it beats a SYMMETRIC arm at matched magnitude by +0.0017, so the gain is the
# asymmetry itself and not the scale. Appearance stays at the pack's 0.1; the 5x ratio
# is the lab's own zebrafish Ultrack setting (notes/03 §3, primary source).
ILP_EDGE_W, ILP_APP_W, ILP_DIS_W, ILP_DIV_W = -1.0, 0.1, 0.5, 1.0
