"""Build notebooks/claude_submit_repair.ipynb — the reproduction PLUS the measured repair.
...
OUT = Path("/workspace/biohub-cell_tracking_during_development/notebooks/claude_submit_repair.ipynb")
CELLS = []
...
md(r"""
# Submission — the reproduction, plus the measured graph repair
...
(WORK / "submit_repair_summary.json").write_text(json.dumps(
...
summary = json.loads((WORK / "submit_repair_summary.json").read_text())
